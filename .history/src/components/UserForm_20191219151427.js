...
export default class UserForm extends Component {
    ...
    componentDidMount() {
        ...
        if (!foo === null || foo === undefined) {
            ...
            var first_name, middle_name, last_name, document_number, ssn, email, phone, address, city, state, zip, employed, employer_name, job_title, emp_phone, income, start_date, income_ext, date_of_birth, date_of_expiry, date_of_issue, document_image, face_image, sex, verified, key, userdata;
